...
public class ItemList : MonoBehaviour {
	...
	void Start() {
		...
		levelOneItems[0] = new Item("Raises health by 30 but lowers speed by 10%", false, 1, 0, 30, 0, 0, 0.0f, 0.0f, -1, 1);
		levelOneItems[1] = new Item("Increases speed by 20% but lowers ammo by 10%", false, 1, 3, 0, 0, 0, -0.1f, 0.0f, -1, 0);
		levelOneItems[2] = new Item("Lowers health by 5 and speed by 5%, equips a slowing web attack", false, 1, 2, -5, -0.05f, 0, 0.0f, 0.0f, 1, 0);
