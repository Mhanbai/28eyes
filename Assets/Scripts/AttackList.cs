...
public class AttackList : MonoBehaviour {
    ...
    [System.NonSerialized] public Attack[] attackType = new Attack[4];
	...
	void Start() {
		...
		attackType [2] = new Attack ("Crab Claw",       10.0f,   20.0f,  50.0f,  0,          1,      2,    3f,       projectiles [2],    false, false, false);
