...
public class AttackList : MonoBehaviour {
	...
	void Start() {
        ...
        attackType [3] = new Attack ("Wing",            10.0f,   50.0f,  20.0f,  0,        3,      2,    2.0f,       projectiles [4],    true, false, false);
        attackType [4] = new Attack ("Ultimate",        90.0f,   10.0f,  50.0f,  0,        1,      7,    1.3f,       projectiles [3],    true, true, true);
