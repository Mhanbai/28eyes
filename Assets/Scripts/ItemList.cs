...
public class ItemList : MonoBehaviour {
    ...
    void Start() {
		...
		levelOneItems[1] = new Item("Equips the body of an eagle, increasing speed by 10% but lowering health by 10",                       false,      1,          1,      -10,             +0.1f,      0,      0.0f,   0.0f,   -1,         1);
		levelOneItems[2] = new Item("Equips the body of a spider, increasing speed by 20% and reducing health by 20",                       false,      1,          1,      -20,             +0.2f,      0,      0.0f,   0.0f,   -1,         0);
        ...
        levelOneItems[4] = new Item("Equips the wings of an eagle, altering your attack to shoot razor sharp feathers!",                    false,      1,          2,      0,                  0f,      0,      0.0f,   0.0f,    3,         1);
