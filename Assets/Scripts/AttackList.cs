...
public class AttackList : MonoBehaviour {
	...
	void Start() {
		...
		attackType [1] = new Attack ("Web",             30.0f,   10.0f,  15.0f,  1,          1,      3,    2f,       projectiles [1],    false, true, true);
		attackType [2] = new Attack ("Crab Claw",       50.0f,   5.0f,  50.0f,  0,          3,      1,    3f,       projectiles [2],    false, false, false);
