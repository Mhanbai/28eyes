...
public class AttackList : MonoBehaviour {
	...
	void Start() {
		...
		attackType [2] = new Attack ("Crab Claw",       10.0f,   20.0f,  20.0f,  0,        1,      2,    3.0f,       projectiles [2],    false, false, false);
        attackType [3] = new Attack ("Wing",            10.0f,   50.0f,  15.0f,  0,        3,      4,    2.0f,       projectiles [4],    false, false, false);
